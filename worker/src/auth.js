// Minimal HMAC-SHA256 JWT helpers on Web Crypto.
//
// The token this signs is stored in an HttpOnly cookie and never handed to
// page scripts. The same signature covers the OAuth `state` parameter, which
// is what lets the sign-in flow stay stateless — no nonce table to write,
// sweep, or get wrong.
